...
const colors = {
  red: 'bg-red-500/15 text-red-700 group-data-hover:bg-red-500/25 dark:bg-red-500/30 dark:text-red-300 dark:group-data-hover:bg-red-500/40',
  orange:
  ...
  green:
    'bg-green-500/15 text-green-700 group-data-hover:bg-green-500/25 dark:bg-green-500/30 dark:text-green-300 dark:group-data-hover:bg-green-500/40',
  emerald:
  ...
  zinc: 'bg-zinc-600/10 text-zinc-700 group-data-hover:bg-zinc-600/20 dark:bg-slate-700/50 dark:text-slate-300 dark:group-data-hover:bg-zinc-700/60',
}
