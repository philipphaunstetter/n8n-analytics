...
const colors = {
  red: 'bg-red-500/15 text-red-700 group-data-hover:bg-red-500/25 dark:bg-red-500/20 dark:text-red-300 dark:group-data-hover:bg-red-500/30',
  orange:
  ...
  green:
    'bg-green-500/15 text-green-700 group-data-hover:bg-green-500/25 dark:bg-green-500/20 dark:text-green-300 dark:group-data-hover:bg-green-500/30',
  emerald:
  ...
  zinc: 'bg-zinc-600/10 text-zinc-700 group-data-hover:bg-zinc-600/20 dark:bg-zinc-500/20 dark:text-zinc-300 dark:group-data-hover:bg-zinc-500/30',
}
