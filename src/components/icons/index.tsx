...
// Analytics Icon - Trending Line Chart
...
// Monitors Icon - Cloud
export function MonitorsIcon({ className, ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
// Tools/Wrench Icon - for Settings in Profile Dropdown
